  ...
  return (
    <div className="relative group">
      <button
        ...
        // Usa textColorClass per cambiare colore dinamicamente
        className={`flex items-center gap-1 ${textColorClass} hover:text-accent transition-colors font-gothic font-medium text-lg uppercase tracking-wide py-2`}
      >
        {title}
...
const Header: React.FC = () => {
  ...
  // LOGICA COLORI:
  // Scrolled (giù) -> Sfondo BIANCO, Testo BLU
  // Top (su)      -> Sfondo BLU, Testo BIANCO
    ...
    <header className={`fixed top-0 z-50 w-full transition-all duration-300 ${headerBgClass}`}>
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex h-20 md:h-24 items-center justify-between">
          ...
          {/* Logo: usa textColorClass per cambiare da bianco a blu */}

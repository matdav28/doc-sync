    ...
    <header className={`fixed top-0 z-50 w-full transition-all duration-300 ${isScrolled ? 'bg-primary/95 backdrop-blur-md shadow-lg' : 'bg-primary'}`}>
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex h-20 md:h-24 items-center justify-between">
          ...
          {/* Logo Modificato: Matteo sopra (900), Migliore sotto (400) */}
          <Link to="/" className="flex flex-col items-start leading-none gap-0.5">
            <span className="font-display text-xl md:text-2xl text-primary-foreground font-black tracking-tight uppercase">
              MATTEO
            </span>
            <span className="font-display text-xl md:text-2xl text-primary-foreground font-normal tracking-tight uppercase">
              MIGLIORE
            </span>
          </Link>

          {/* Desktop Nav - Ripristinato come prima */}
